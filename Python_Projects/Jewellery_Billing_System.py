...
f.write(f"----------your bill------------ \nName : {name} \nGender : {gender} \nAge = {age} \nproduct : {product_list} \nproduct Gram : {gram2}/g \ngold price : {gold_price} \n---------------------------------------------- \nTotal gold rate : {total_rate} \n")
f.write(f"Making charges : {making_charg}/g \nTotal making charges : {total_charg} \n------------------------------------ \nTotal Amount : {total_amount}\n")
...
f.write(f"------------------------------------- \nTotal net amount = {total_net_amount}Rs. \n\n")